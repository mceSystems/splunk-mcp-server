"""MCP Prompts for the Splunk MCP server."""
...
def register(mcp: "FastMCP") -> None:
    @mcp.prompt()
    def splunk_workflow_guide() -> str:
        """Complete guide to Splunk MCP tools: workflows, tool selection, gotchas, and SPL patterns."""
        return _GUIDE
